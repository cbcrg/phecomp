...
if ($#ARGV ==-1)
  {
    ...
    print "  -ws          <int>..............Int: Duration of the window in seconds, by default 1800 seconds.\n";    
...
if (exists ($param->{window}))
  {
    &data2winDistro ($d, $param);
  }
...
sub data2winDistro 
	{
    	...
    	my $winMode = $param -> {winMode}? $param -> {winMode} : "cumulative";
